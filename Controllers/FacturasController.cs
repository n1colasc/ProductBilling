...
{
    /// <summary>
    /// Permite ejecutar funcionalidades de lectura, creación, actualización y eliminación de las facturas
    /// </summary>
    [Authorize]
    ...
    public class FacturasController : System.Web.Http.ApiController
    {
        ...
        /// <summary>
        /// Permite consultar la(s) factura(s) del cliente (persona)
        /// </summary>
        /// <param name="Tipo_Documento">Tipo de documento de la persona</param>
        /// <param name="Numero_Documento">Número de identificación de la persona</param>
        /// <param name="Numero_Factura">Número de factura para consulta individual (Opcional)</param>
        /// <returns>Información asociada a la factura</returns>
        [HttpGet]
        [Route("v1/get")]
        ...
        /// </summary>
        /// <returns>OK si creó la factura, FALSE si hubo una excepción</returns>
        [HttpPost]
        [Route("v1/insert")]
        ...
        /// </summary>
        /// <returns>OK si actualizó la factura, FALSE si hubo una excepción</returns>
        [HttpPatch]
        [Route("v1/update")]
